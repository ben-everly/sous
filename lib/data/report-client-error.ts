...
// otherwise be silent.
// Before sending anywhere off-device, scrub: a PostgREST error's message/details/hint can carry row and
// column values, so report code plus a static category, not the raw fields.
